            ...
            <div class="row">
                <div class="col-sm">
                    <form data-fn="data-processing-form" data-fn-options="{ cookieName: 'dataProcessingConsent', cookieExpiresDays: 365, categoryInputSelector: '[data-g-tg=category-input]' }">
                        ...
                        <div class="d-inline-block align-middle py-1">
                            <button class="btn btn-outline-primary btn-sm" data-fn="cookie-related-elem-close" data-g-fn="reject-all"><?php echo esc_html__( 'Reject all', 'bsx-wordpress' ); ?></button>
                            <button class="btn btn-outline-primary btn-sm" type="submit" data-fn="cookie-related-elem-close" data-g-fn="save"><?php echo esc_html__( 'Save my choice', 'bsx-wordpress' ); ?></button>
